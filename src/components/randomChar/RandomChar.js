...
const View = ({char}) =>
{
    ...
    return (
        <div className="randomchar__block">
            <img src={thumbnail} style={{objectFit: imgNotFound ? "contain" : "cover"}}  alt="Random character" className="randomchar__img"/>
            <div className="randomchar__info">
                <p className="randomchar__name">{name}</p>
                <p className="randomchar__descr">{description ? description : 'no desc'}</p>
